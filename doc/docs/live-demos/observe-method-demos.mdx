...
And those are live demos on how to use the `observe()` in your project, to play around even more e.g. customizing observer options, writing custom css animation classes, you can checkout the [**Playground**](../playground) page.